...
Circle.prototype.drawCircle = function(rf) {
    ...
    drawHeart(this.x, this.y, this.radius * rf * 1.5, "white");
};
...
var Curve = function () {
    ...
    this.drawCurve = () => {
        ...
        ctx.strokeStyle = "rgba(78, 128, 92, 0.6)"; // Set the stroke color to dark green
...
ctx.fillStyle = "white"; // Set the initial color to white
ctx.lineWidth = 5;
...
// body.addEventListener("click", start, false); // Commented this line to start animation without click
...
// Call the necessary functions to set up the animated background
onresize();
setCircles();
ctx.strokeStyle = "hsla(" + getRandomInt(0, 360) + ",90%,60%,0.6)";
